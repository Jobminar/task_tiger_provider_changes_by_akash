...
var _NgxLoadingService = class _NgxLoadingService {
  constructor(config) {
    this.config = config;
...
_NgxLoadingService.ɵprov = ɵɵdefineInjectable({
  token: _NgxLoadingService,
  factory: _NgxLoadingService.ɵfac,
  providedIn: "root"
});
var NgxLoadingService = _NgxLoadingService;
(() => {
...
var _NgxLoadingComponent = class _NgxLoadingComponent {
...
_NgxLoadingComponent.ɵcmp = ɵɵdefineComponent({
...
var NgxLoadingComponent = _NgxLoadingComponent;
(() => {
...
var _NgxLoadingModule = class _NgxLoadingModule {
...
_NgxLoadingModule.ɵmod = ɵɵdefineNgModule({
  type: _NgxLoadingModule,
  declarations: [NgxLoadingComponent],
  imports: [CommonModule],
  exports: [NgxLoadingComponent]
});
_NgxLoadingModule.ɵinj = ɵɵdefineInjector({
  imports: [CommonModule]
});
var NgxLoadingModule = _NgxLoadingModule;
(() => {
